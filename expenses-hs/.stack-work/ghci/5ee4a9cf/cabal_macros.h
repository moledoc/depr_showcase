...
/* package expenses-hs-0.1.0.0 */
#ifndef VERSION_expenses_hs
#define VERSION_expenses_hs "0.1.0.0"
#endif /* VERSION_expenses_hs */
#ifndef MIN_VERSION_expenses_hs
#define MIN_VERSION_expenses_hs(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_expenses_hs */
...
#define CURRENT_COMPONENT_ID "expenses-hs-0.1.0.0-3yMbnib2TCS9y03SqWO8BU-expenses-hs"
