...
```{python results}
N = 1000000 * np.array([1,2.5,5,7.5,10], dtype=int)
EX = []
error = []
type = []
walltime = []
...
dfPar = pd.read_csv("resultsPar.csv",header=0,names=["n","EX","error","type","walltime","processes"])
print(dfPar)
...
# dfPar.join(dfSer,on="n",lsuffix=".par",rsuffix=".ser")
# TODO: plot relative speedups
```
